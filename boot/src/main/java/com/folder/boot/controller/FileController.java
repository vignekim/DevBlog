...
import com.folder.boot.service.FileService;
...
public class FileController {
  ...
  @GetMapping("/User/{no}")
  public ResponseEntity<?> user(@PathVariable("no") int no) {
    return fileService.userById(no);
  }
/*
...
*/
  ...
  @PostMapping("/User")
  public ResponseResult user(@RequestParam("file") MultipartFile multipartFile, HttpServletRequest request) {
    return fileService.user(multipartFile, request);
  }
/*
